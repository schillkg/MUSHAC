...
#i = 0
    ...
    data_path = "/share5/nathv/CDMRI_Challenge_2018/patches/s%s_A2C_5Patches.mat" % (dirs[i])
    print(data_path)
...
train_loss_file = 'BLAHFCN_L5PATCH_A2C_train_loss_split.txt'
f = open(train_loss_file, 'w')
f.close()
validate_loss_file = 'BLAHFCN_L5PATCH_A2C_validate_loss_split.txt'
f = open(validate_loss_file, 'w')
f.close()

model_file = 'BLAHFCN_L5PATCH_A2C_saved_model_split'
