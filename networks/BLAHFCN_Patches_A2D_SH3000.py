...
bs_size = 1000
train_loss_file = 'BLAHFCN_PATCH_A2D_SH3000_train_loss_split.txt'

validate_loss_file = 'BLAHFCN_PATCH_A2D_SH3000_validate_loss_split.txt'


model_file = 'BLAHFCN_PATCH_A2D_SH3000_saved_model_split'
