...
for i = 1:length(sets)
    ...
    % A=>B
    SH1200 = ['BLAHFCN_s' ii '_A2B_SH1200.nii.gz']; SH1200 = load_untouch_nii_gz(SH1200); SH1200 = SH1200.img;
    SH3000 = ['BLAHFCN_s' ii '_A2B_SH3000.nii.gz']; SH3000 = load_untouch_nii_gz(SH3000); SH3000 = SH3000.img;
    ...
    nii_name = ['Results/dwi_' ii '_A2B_BLAHFCN_rescale.nii.gz']
    ...
    % A=>C
    SH1200 = ['BLAHFCN_s' ii '_A2C_SH1200.nii.gz']; SH1200 = load_untouch_nii_gz(SH1200); SH1200 = SH1200.img;
    SH3000 = ['BLAHFCN_s' ii '_A2C_SH3000.nii.gz']; SH3000 = load_untouch_nii_gz(SH3000); SH3000 = SH3000.img;
    ...
    nii_name = ['Results/dwi_' ii '_A2C_BLAHFCN_rescale.nii.gz']
    orig_image = ['/Volumes/GRAID/Harmonization/Testing_Data/' ii '/prisma/st/A2C_noTRnoTE_dwi.nii.gz']
    orig_bval = ['/Volumes/GRAID/Harmonization/Testing_Data/' ii '/prisma/st/noTRnoTE_dwi.bval']
    MatchSchemeGivenSH_rescale_v2(SH1200,SH3000,nifti_template,bvec_to_match,bval_to_match,nii_name,orig_image,orig_bval)

    % A=>D
    SH1200 = ['BLAHFCN_s' ii '_A2D_SH1200.nii.gz']; SH1200 = load_untouch_nii_gz(SH1200); SH1200 = SH1200.img;
    SH3000 = ['BLAHFCN_s' ii '_A2D_SH3000.nii.gz']; SH3000 = load_untouch_nii_gz(SH3000); SH3000 = SH3000.img;
    ...
    nii_name = ['Results/dwi_' ii '_A2D_BLAHFCN_rescale.nii.gz']
